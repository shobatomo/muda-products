        ...
        <section className="min-h-screen bg-[#f1f0ec]">
            <div className="mx-auto grid min-h-screen max-w-[1440px] grid-cols-1 items-center gap-12 px-6 pb-12 pt-28 md:px-10 lg:grid-cols-[0.8fr_1.2fr] lg:gap-16 lg:px-16 lg:pb-16 lg:pt-24">
                ...
                <div className="relative flex min-h-[420px] items-center justify-center overflow-hidden rounded-sm bg-[#e6e4de] lg:min-h-[680px]">
                    <div className="absolute left-6 top-6 text-[10px] tracking-[0.2em] text-black/40">
                        INTERACTIVE OBJECT
                    </div>

                    <div className="flex h-52 w-52 items-center justify-center border border-black/15 bg-black/5 text-xs tracking-[0.2em] text-black/40 sm:h-64 sm:w-64">
                        3D OBJECT
                    </div>

                    <div className="absolute bottom-6 right-6 text-[10px] tracking-[0.2em] text-black/40">
                        DRAG TO ROTATE
                    </div>
                </div>
            </div>
